...
class Themis < Formula
  ...
  # Early Linux installs registered as version "64-unknown-linux-gnu" (brew's
  # URL scanner misparsed the x86_64 basename until its July 2026 release-URL
  # version-detection fix), which compares HIGHER than any real version. The
  # scheme bump lets 0.1.0+ supersede those installs.
  version_scheme 1
