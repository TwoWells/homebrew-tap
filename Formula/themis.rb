...
class Themis < Formula
  ...
  # Prebuilt binaries exist only for macOS arm64 and Linux x86_64; other
  # platforms simply have no url, so brew reports it's unavailable there (an
  # odie here would abort formula evaluation and break `brew audit`). The
